...
public class MainLRU {
    public static void main(String[] args) {
        // Create a cache with a simple LRU eviction policy and storage capacity of 3
        EvictionPolicy<String> evictionPolicy = new LRUPolicy<>();
        Storage<String, String> storage = new ConcurrentHashMapStorage<>(3);
        Cache<String, String> cache = new Cache<>(evictionPolicy, storage, true);
        ...
        System.out.println("Get key '3': " + cache.get("3")); // Might be null if evicted
        ...
        // Check final state
        System.out.println("Get key '1': " + cache.get("1")); // Might be null if evicted
