...
public class MainFIFO {
    public static void main(String[] args) {
        // Create a cache with a FIFO eviction policy and storage capacity of 3
        EvictionPolicy<String> evictionPolicy = new FifoEvictionPolicy<>();
        ...
        System.out.println("Get key '1': " + cache.get("1")); // Should print null if evicted
        ...
        // Check final state
        System.out.println("Get key '2': " + cache.get("2")); // Should print null if evicted
        System.out.println("Get key '5': " + cache.get("5")); // Should print "Five"
        System.out.println("Get key '6': " + cache.get("6")); // Should print "Six"
        System.out.println("Get key '4': " + cache.get("4")); // Should print "Six"
